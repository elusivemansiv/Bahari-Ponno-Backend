...
class ProductVariationSerializer(serializers.ModelSerializer):
    color = ColorSerializer(read_only=True)
    quantity = QuantitySerializer(source='size', read_only=True)
    class Meta:
        model = ProductVariation
        fields = ['id', 'color', 'quantity', 'price', 'stock']
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    available_quantities = serializers.SerializerMethodField()
    ...
    def get_available_quantities(self, obj):
        quantities = Size.objects.filter(productvariation__product=obj).distinct()
        return QuantitySerializer(quantities, many=True).data
...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CartItem
        fields = ['id', 'product', 'product_id', 'quantity', 'color', 'size', 'subtotal', 'effective_price', 'selected_image']
